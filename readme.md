...
[SBER: Обучение модели естественного языка с BERT и Tensorflow](https://habr.com/ru/company/sberdevices/blog/527576/)<br>
    - Сколько, каких GPU, сколько тренировали?: Сперва неделя претрейна на 32 V100 [Кристофари], затем 50 часов тюнинга на 16 V100 [DGX-2]<br>
[Всё, что вы хотели знать о перцептронах Розенблатта, но боялись спросить](https://habr.com/ru/company/sberdevices/blog/529932/)<br>
[]()<br>
[]()<br>
